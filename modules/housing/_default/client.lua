-- Default housing fallback (client).
...
if not olink._hasOverride('Housing') and GetResourceState('qb-apartments') == 'started' then return end
if not olink._hasOverride('Housing') and GetResourceState('qb-houses') == 'started' then return end
if not olink._hasOverride('Housing') and GetResourceState('qbx_properties') == 'started' then return end
