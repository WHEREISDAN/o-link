if not olink._guardImpl('License', 'qb-core', 'qb-core') then return end
if not olink._hasOverride('License') and GetResourceState('qbx_core') == 'started' then return end
...
-- Force a save: QB's SetMetaData is in-memory only.
...
olink._register('license', {
    ---@return string
    GetResourceName = function() return 'qb-core' end,
