...
if Config.Debug then
    ...
    local modules = { 'callback', 'framework', 'character', 'job', 'inventory', 'notify', 'helptext', 'target', 'progressbar', 'vehiclekey', 'fuel', 'weather', 'input', 'menu', 'radial', 'zones', 'placement', 'phone', 'clothing', 'dispatch', 'doorlock', 'housing', 'bossmenu', 'skills', 'entity', 'death', 'gang', 'vehicleproperties', 'logger' }
